        ...
        <div class="flex flex-col md:flex-row">
            ...
            <section class="w-full rounded-xl">
                <div id="main" class="flex-1 w-full h-full pb-24 mt-12 bg-gray-100 main-content md:mt-2 md:pb-5">
                    <div class="px-6 py-4 text-3xl font-semibold text-left text-white bg-black shadow text-start" style="font-family:Georgia, 'Times New Roman', Times, serif ">
                        Frekuensi Data
                    </div>
                    <!-- Main content -->
                    <div class="flex flex-col">
                        ...
                        <div class="inline-block w-1/2 px-12 py-4 ml-12 sm:px-6 lg:px-8">
                            ...
                            <table class="min-w-full text-center ">
                                <thead class="bg-gray-300 border-b rounded-2xl">
                                <tr>
