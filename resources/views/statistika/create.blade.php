                ...
                <div id="main" class="flex-1 w-full h-full pb-24 mt-12 bg-gray-100 main-content md:mt-2 md:pb-5">
                    ...
                    <div class="bg-blue-500 ">
                        <div
                            ...
                            <h1 class="pl-2 font-bold">Input Data</h1>
                        </div>
                    </div>
                    <div
                        class="w-full h-screen text-xl text-justify text-black bg-transparent">
                        <div class="container">
                            <div class="mx-6 ">
                                ...
                                <form action="/dataupdate" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-6">
                                        <label for="kelas" class="block mb-2 text-sm font-medium text-gray-900">Kelas :</label>
                                            <select class="px-20 py-2 text-base border rounded-lg" name="Kelas" id="kelas">
                                                <option name="Kelas" id="IKI" value="IKI" selected>Inisiasi Kelas Internasional</option>
                                    ...
                                    <button type="submit"
                                        class="text-black bg-gray-300 hover:bg-white focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 focus:outline-none">Tambah</button>
                                </form>
                            </div>
                        </div>
                    </div>
