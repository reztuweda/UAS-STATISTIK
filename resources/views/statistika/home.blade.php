...
<body class="mt-12 font-sans leading-normal tracking-normal bg-gray-100">
    ...
    <header>
        <!--Nav-->
        <nav aria-label="menu nav" class="fixed top-0 z-20 w-full h-auto px-1 pt-2 pb-1 mt-0 bg-gray-700 shadow md:pt-1">
                ...
                <div class="flex justify-center flex-1 px-2 text-white md:w-1/3 md:justify-start">
                    <span class="relative w-full">
                        <input aria-label="search" type="text" type="text" id="search" name="search" placeholder=""
                            class="w-full px-2 py-3 pl-10 leading-normal text-white transition bg-gray-700 border border-transparent rounded appearance-none focus:outline-none focus:border-gray-400">
        ...
        <section class="w-full rounded-xl">
            ...
            <div class="bg-blue-500 ">
                ...
                <div class="w-full h-full p-6 text-justify text-black bg-transparent shadow text-md rounded-tl-3xl">
                    <div class="card-body">
                        <p>
                          &emsp14; &emsp14;  &emsp14; &emsp14;  &emsp14; &emsp14;Statistika merupakan ilmu yang berkaitan dengan cara merancang, mengumpulkan, menganalisis, menginterpretasi, dan mempresentasikan data. Kata 'statistika' (dalam bahasa Inggris: statistics) berbeda dengan 'statistik' (statistic). Statistik merupakan data, informasi, atau hasil penerapan algoritme statistika pada suatu data, sedangkan statistika adalah ilmu yang berkaitan dengan data tersebut. Dengan menggunakan kumpulan data, statistika dapat digunakan untuk menyimpulkan atau mendeskripsikan data, yang disebut statistika deskriptif. Konsep dasar statistika pada umumnya mengasumsikan teori probabilitas. Beberapa istilah yang terkait dengan statistika diantaranya adalah populasi, sampel, unit sampel, dan probabilitas.
                          </p><br>
                          <p>
                          &emsp14; &emsp14;  &emsp14; &emsp14;  &emsp14; &emsp14;Statistik digunakan dalam berbagai disiplin ilmu seperti ilmu alam, ilmu sosial, bisnis, ekonomi, dan industri. Hal ini juga diterapkan dalam pemerintahan untuk tujuan seperti sensus penduduk. Aplikasi statistika yang populer saat ini termasuk jajak pendapat atau polling dan perhitungan cepat hasil pemilu. Di bidang komputasi, statistika juga digunakan dalam pengenalan pola dan kecerdasan buatan.
                          Penggunaan istilah statistika berasal dari istilah dalam bahasa Latin modern yaitu statisticum collegium ("dewan negara") dan bahasa Italia yaitu statista ("negarawan" atau "politikus"). Gottfried Achenwall pertama kali menggunakan istilah Statistik dalam bahasa Jerman pada tahun 1749 untuk merujuk pada kegiatan analisis data kenegaraan, dengan makna "ilmu tentang negara (state)". Pada awal abad ke-19, makna istilah ini bergeser menjadi "ilmu mengenai pengumpulan dan klasifikasi data". Sir John Sinclair kemudian memperkenalkan istilah dan pengertian ini ke dalam bahasa Inggris. Jadi, secara prinsip, statistika awalnya hanya mengurus data yang digunakan oleh lembaga-lembaga administratif dan pemerintah. Pengumpulan data terus berlangsung, terutama melalui sensus yang dilakukan secara teratur untuk memberikan informasi tentang kependudukan yang berubah setiap saat.
                          </p><br>
                          <p>
                            &emsp14; &emsp14;  &emsp14; &emsp14;  &emsp14; &emsp14;Walaupun masih ada banyak orang yang menganggap statistika sebagai bagian dari matematika, ada juga orang lain yang menganggapnya sebagai bidang yang banyak terkait dengan matematika karena sejarah dan aplikasinya. Di Indonesia, studi statistika kebanyakan termasuk dalam fakultas matematika dan ilmu pengetahuan alam, baik dalam departemen tersendiri atau bersama-sama dengan matematika.
                          </p>
                      </div>
                </div>
